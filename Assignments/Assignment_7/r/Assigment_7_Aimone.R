...
#this cleaned my data so that my variables were not spread out in multiple columns. I am assuming that the original values for each other these religions was a % of the religious population so I called it accordingly 
dat<-dat %>% 
